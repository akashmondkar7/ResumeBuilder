...
const Footer = () => {
  return (
    ...
    <footer className="flex  justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
                <div className="flex  items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a href="#">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><a href="/" className="hover:text-green-800 transition">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1 whitespace-nowrap">We’re hiring!</span></a></li>
